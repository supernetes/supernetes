...
func (s *KubeletServer) Run(ctx context.Context, log *zerolog.Logger) (err error) {
	...
	mgrCtx, cancel := context.WithTimeoutCause(ctx, 300*time.Second, errServingCertTimeout)
	defer cancel()
